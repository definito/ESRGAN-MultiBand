...
config_dict = {
    ...
    'discriminator_filters': [64, 64, 128, 128, 256, 256, 512], # Filters for the discriminator
    'warmup_batches': 10000,
    'warmup_lambda_content': 0.0, # Warmup weight for content loss
    'warmup_lambda_pixel': 1.0, # Warmup weight for pixel loss
    'warmup_lambda_tv': 0.0, # Warmup weight for TV loss
    'lambda_adv': 0.0001,
    'lambda_pixel': 1.0, # Pixel loss weight L1 weight
    'lambda_content': 0.01, # Content loss weight L1 weight
    'lambda_tv': 1e-5, # TV loss weight
    'vgg19_path': "/home/users/dborman/FINAL_CODE/FINAL_DL/Pretained/vgg19.pth",
    'NORMALIZE_MEAN_HR': NORMALIZE_MEAN_HR,
    'NORMALIZE_STD_HR': NORMALIZE_STD_HR,
    'images_saved_dir': "images_vgg/validation",
    'saved_models_dir': "saved_models_vgg",
    'lr_scheduler_step_size': 100000,  # Step size for the learning rate scheduler
    'lr_scheduler_gamma': 0.5,  # Gamma for the learning rate scheduler
    'use_channel_attention': True,  
    'vgg19_channels': 3,  # Number of channels in the VGG19 feature extractor
}
...
# CKPT_PATH = "/home/users/dborman/MODEL_ESR/FINAL/B_5678_0_Norma/saved_models/model_epoch=54_psnr_val/psnr=33.73-v1.ckpt"  # Path to a checkpoint if you want to resume training
